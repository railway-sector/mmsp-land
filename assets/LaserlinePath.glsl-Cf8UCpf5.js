import{KM as be,KI as we,Lh as De,AH as f,AQ as w,KR as Ve,Je as B,AI as r,dh as j,A9 as ee,KL as xe,AO as E,ao as te,al as M,gu as F,Li as Le,gV as ie,AG as ne,Jz as S,ey as _,ak as v,Lj as se,AS as ae,am as o,oA as re,gt as ye,u4 as Ee,ap as Se,aB as le,fr as oe,gr as Ce,KJ as Ae,An as Me,Jx as $e,K8 as Re,AR as H,bN as Te,t2 as ce,t4 as he,_ as de,eA as Oe,bE as G,sF as z,q as c,w as q,ki as pe,eB as ue,ai as Ie,an as I,nI as Ue,JK as ze,nK as je,Lk as qe,AZ as V,qf as Ne,qg as K,Ll as We,pj as Be,Lm as $,Ln as Fe,zc as k,u0 as He,x9 as Ge,u1 as Ke,u2 as ke,u3 as Je,u5 as Qe,v as C,Lo as Xe,bG as J}from"./index-DklaDf-x.js";import{t as Ze}from"./VisualElement-CSKRYfa7.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),M(d,D),d[3]=F(D),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>A(s)),new E("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>A(i)),new E("pointDistanceSphere",(i,s)=>Ye(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
vec4 pointDistanceSphereColor = laserlineProfile(pointDistanceSphereDistance);
float pointDistanceSphereAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, normalize(pos - pointDistanceSphere.xyz))));
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);`)),t.lineVerticalPlaneEnabled&&(n.uniforms.add(new S("angleCutoff",i=>A(i)),new E("lineVerticalPlane",(i,s)=>et(i,s)),new w("lineVerticalStart",(i,s)=>tt(i,s)),new w("lineVerticalEnd",(i,s)=>it(i,s))),n.main.add(r`if (pointIsWithinLine(pos, lineVerticalStart, lineVerticalEnd)) {
float lineVerticalDistance = planeDistancePixels(lineVerticalPlane, pos);
vec4 lineVerticalColor = laserlineProfile(lineVerticalDistance);
float lineVerticalAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, lineVerticalPlane.xyz)));
color = max(color, lineVerticalColor * lineVerticalAlpha);
}`)),t.intersectsLineEnabled&&(n.uniforms.add(new S("angleCutoff",i=>A(i)),new w("intersectsLineStart",(i,s)=>_(u,i.lineStartWorld,s.camera.viewMatrix)),new w("intersectsLineEnd",(i,s)=>_(u,i.lineEndWorld,s.camera.viewMatrix)),new w("intersectsLineDirection",(i,s)=>(v(d,i.intersectsLineSegment.vector),d[3]=0,M(u,se(d,d,s.camera.viewMatrix)))),new f("intersectsLineRadius",i=>i.intersectsLineRadius)),n.main.add(r`if (pointIsWithinLine(pos, intersectsLineStart, intersectsLineEnd)) {
float intersectsLineDistance = lineDistancePixels(intersectsLineStart, intersectsLineDirection, intersectsLineRadius, pos);
vec4 intersectsLineColor = laserlineProfile(intersectsLineDistance);
float intersectsLineAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, 1.0 - abs(dot(normal, intersectsLineDirection)));
color = max(color, intersectsLineColor * intersectsLineAlpha);
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function A(t){return re(nt,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-j(2))))}function Ye(t,e){return _(U,t.pointDistanceOrigin,e.camera.viewMatrix),U[3]=ie(t.pointDistanceOrigin,t.pointDistanceTarget),U}function et(t,e){const n=Ee(t.lineVerticalPlaneSegment,.5,u),i=t.renderCoordsHelper.worldUpAtPosition(n,st),s=M(D,t.lineVerticalPlaneSegment.vector),a=Se(u,i,s);return M(a,a),me(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function tt(t,e){const n=v(u,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),_(n,n,e.camera.viewMatrix)}function it(t,e){const n=le(u,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),_(n,n,e.camera.viewMatrix)}function me(t,e,n){return _(Q,t,n),v(d,e),d[3]=0,se(d,d,n),ye(Q,d,at)}const nt=oe(),u=o(),d=ae(),st=o(),D=o(),Q=o(),at=Ce(),U=ae(),rt=Object.freeze(Object.defineProperty({__proto__:null,build:ge,defaultAngleCutoff:N},Symbol.toStringTag,{value:"Module"}));function _e(t){const e=new ee;e.include(fe,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Ae("modelView",(a,{camera:l})=>Me(ot,l.viewMatrix,a.origin)),new $e("proj",({camera:a})=>a.projectionMatrix),new f("glowWidth",(a,{camera:l})=>a.glowWidth*l.pixelRatio),new Re("pixelToNDC",({camera:a})=>re(lt,2/a.fullViewport[2],2/a.fullViewport[3]))),e.attributes.add("start","vec3"),e.attributes.add("end","vec3"),t.spherical&&(e.attributes.add("startUp","vec3"),e.attributes.add("endUp","vec3")),e.attributes.add("extrude","vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
