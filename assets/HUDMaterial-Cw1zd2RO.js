const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HUDMaterial.glsl-B44gKKyM.js","assets/index-BtfVDnMY.js","assets/index-C-nr2iD2.css","assets/oitResolution.glsl-BJ5NitzQ.js","assets/NoParameters-DB-WZ6gy.js","assets/ShaderBuilder-CQWFevrL.js","assets/TriangleTechniqueConfiguration-I_maMT41.js","assets/frustum-CKN4QOtu.js","assets/ray-DIWCk0y8.js","assets/vectorStacks-DP_slPPw.js","assets/quatf64-aQ5IuZRd.js","assets/plane-kka40C6-.js","assets/sphere-dt6_ociR.js","assets/VertexAttributeLocations-BbZcVAQD.js","assets/VertexElementDescriptor-CVzmm3VW.js","assets/renderState-B75k4q4B.js","assets/Indices-CwAIIRM0.js","assets/Attribute-DGhdp5lO.js","assets/BufferView-CUJmd3lf.js","assets/lineSegment-CxfJVn5H.js","assets/RibbonLine.glsl-DBss8vms.js","assets/computeTranslationToOriginAndRotation-BxVRgU14.js","assets/localRotationUtils-2_KlKHsn.js","assets/WebGLLayer-DsjUNHAw.js","assets/mathUtils-C44Gspdz.js","assets/Octree-CNY8x1w9.js","assets/InterleavedLayout-CL4JEoNo.js","assets/SceneLighting-Uu2xDqEE.js","assets/projectVectorToVector-CypBliZ9.js","assets/projectPointToVector-BcvN_cBz.js","assets/dehydratedPoint-Z5ONvFg_.js","assets/orientedBoundingBox-DrvZuIN9.js","assets/quat-C6NyL6va.js","assets/RenderingContext-CqAM4jN4.js","assets/ProgramCache-le7Plq8n.js","assets/VertexArrayObject-DSDSJEPc.js","assets/VertexBuffer-DevKPND4.js"])))=>i.map(i=>d[i]);
import{cN as ct,X as ft,R as dt,eF as ut,t5 as pt,cE as ht,D as h,J as ue,_ as je,F as ee,bH as vt,rJ as mt,t6 as xt,i8 as pe,lM as he,pf as gt,jy as Ot,eL as ge,eV as G,f6 as Y,cf as Oe,eS as Ct,eT as k,hv as Ce,km as Se,jV as te,c6 as St,cr as j,hb as Q,ib as bt,eW as yt,fa as wt,bd as zt,c1 as R,q6 as be,p9 as $t,sD as Me,jS as ve,cp as Pt,cc as Vt,gZ as At,cs as _t,c7 as Ft,c3 as Dt}from"./index-BtfVDnMY.js";import{u as Et}from"./hydratedFeatures-DYinNFgZ.js";import{i as Rt,Q as Ut}from"./BufferView-CUJmd3lf.js";import{f as Tt,D as It,K as q,L as ye,M as jt,N as Be,O as Z,i as He,t as Le,S as Mt,u as Bt,d as Ht,b as Lt,c as qt,e as ae,P as Gt,y as ce,Q as we,R as kt,g as Nt,k as Wt,o as Yt,T as Xt,U as Qt,s as Zt,V as N,W as Jt,X as Kt,Y as ea,x as re,Z as ta,_ as aa,$ as ra,a0 as sa,a1 as oa,a2 as ze,a3 as $e,a4 as ia,a5 as se,a6 as na,a7 as la}from"./TriangleTechniqueConfiguration-I_maMT41.js";import{d as ca,r as fa,a as da,l as ua,b as pa}from"./BooleanBindUniform-dL0ManW3.js";import{s as qe,e as Ge,i as ke,o as ha,a as Ne,u as va,b as W,c as oe,t as ma}from"./SceneLighting-Uu2xDqEE.js";import{t as l,n as A,i as O}from"./oitResolution.glsl-BJ5NitzQ.js";import{s as xa}from"./RibbonLine.glsl-DBss8vms.js";import{c as ga}from"./NoParameters-DB-WZ6gy.js";import{s as We}from"./ShaderBuilder-CQWFevrL.js";import{O as Ye,g as Xe,u as Oa}from"./renderState-B75k4q4B.js";import{Q as Qe,t as Pe}from"./InterleavedLayout-CL4JEoNo.js";const Ca=()=>dt.getLogger("esri.views.3d.layers.graphics.featureExpressionInfoUtils");function Sa(a){return{cachedResult:a.cachedResult,arcade:a.arcade?{func:a.arcade.func,context:a.arcade.modules.arcadeUtils.createExecContext(null,{sr:a.arcade.context.spatialReference}),modules:a.arcade.modules}:null}}async function ar(a,e,r,t){const s=a?.expression;if(typeof s!="string")return null;const i=za(s);if(i!=null)return{cachedResult:i};const u=await ct();ft(r);const o=u.arcadeUtils,p=o.createSyntaxTree(s);if(!p)return null;if(o.dependsOnView(p))return t?.error("Expressions containing '$view' are not supported on ElevationInfo"),{cachedResult:0};const d=o.createFunction(p);return d?{arcade:{modules:u,func:d,context:o.createExecContext(null,{sr:e})}}:null}function ba(a,e,r){return a.arcadeUtils.createFeature(e.attributes,e.geometry,r)}function ya(a,e){if(a!=null&&!Ze(a)){if(!e||!a.arcade)return void Ca().errorOncePerTick("Arcade support required but not provided");const r=e;r._geometry&&(r._geometry=Et(r._geometry)),a.arcade.modules.arcadeUtils.updateExecContext(a.arcade.context,e)}}function wa(a){if(a!=null){if(Ze(a))return a.cachedResult;const e=a.arcade;let r=e?.modules.arcadeUtils.executeFunction(e.func,e.context);return typeof r!="number"&&(a.cachedResult=0,r=0),r}return 0}function rr(a,e=!1){let r=a?.featureExpressionInfo;const t=r?.expression;return e||t==="0"||(r=null),r??null}const sr={cachedResult:0};function Ze(a){return a.cachedResult!=null}function za(a){return a==="0"?0:null}class Je{constructor(){this._meterUnitOffset=0,this._renderUnitOffset=0,this._unit="meters",this._metersPerElevationInfoUnit=1,this._featureExpressionInfoContext=null,this.mode=null,this.centerInElevationSR=null}get featureExpressionInfoContext(){return this._featureExpressionInfoContext}get meterUnitOffset(){return this._meterUnitOffset}get unit(){return this._unit}set unit(e){this._unit=e,this._metersPerElevationInfoUnit=ut(e)}get requiresSampledElevationInfo(){return this.mode!=="absolute-height"}reset(){this.mode=null,this._meterUnitOffset=0,this._renderUnitOffset=0,this._featureExpressionInfoContext=null,this.unit="meters"}set offsetMeters(e){this._meterUnitOffset=e,this._renderUnitOffset=0}set offsetElevationInfoUnits(e){this._meterUnitOffset=e*this._metersPerElevationInfoUnit,this._renderUnitOffset=0}addOffsetRenderUnits(e){this._renderUnitOffset+=e}geometryZWithOffset(e,r){const t=this.calculateOffsetRenderUnits(r);return this.featureExpressionInfoContext!=null?t:e+t}calculateOffsetRenderUnits(e){let r=this._meterUnitOffset;const t=this.featureExpressionInfoContext;return t!=null&&(r+=wa(t)*this._metersPerElevationInfoUnit),r/e.unitInMeters+this._renderUnitOffset}setFromElevationInfo(e){this.mode=e.mode,this.unit=pt(e.unit)?e.unit:"meters",this.offsetElevationInfoUnits=e.offset??0}setFeatureExpressionInfoContext(e){this._featureExpressionInfoContext=e}updateFeatureExpressionInfoContextForGraphic(e,r,t){e.arcade?(this._featureExpressionInfoContext=Sa(e),this.updateFeatureExpressionFeature(r,t)):this._featureExpressionInfoContext=e}updateFeatureExpressionFeature(e,r){const t=this.featureExpressionInfoContext;t?.arcade&&(t.cachedResult=void 0,ya(this._featureExpressionInfoContext,e.geometry?ba(t.arcade.modules,e,r):null))}static fromElevationInfo(e){const r=new Je;return e!=null&&r.setFromElevationInfo(e),r}}const Ke=.5;function $a(a,e){const r=a.vertex;a.include(qe),a.attributes.add("position","vec3"),a.vertex.inputs.add("position",()=>"position"),a.attributes.add("normal","vec3"),e.hasVertexCenterOffset?a.attributes.add("centerOffset","vec3"):r.constants.add("centerOffset","vec3",[0,0,0]),a.attributes.add("groundDistance","float"),Tt(r,e),It(r,e),r.uniforms.add(new Ge("viewport",t=>t.camera.fullViewport),new q("polygonOffset",t=>t.shaderPolygonOffset),new ye("aboveGround",t=>t.camera.aboveGround?1:-1)),e.hasVerticalOffset&&ca(r),r.code.add(l`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
...
posProj = alignToPixelOrigin(posProj, viewport.zw);
    ...
    vsize = inputSize;
  `);const V=ce(r)&&a.hasFocusAreaStyle&&!a.draped;switch(f.uniforms.add(new Z("tex",n=>n.texture)),V&&f.uniforms.add(new Ne("focusAreaStyle",n=>_a(n.focusAreaStyle))),m&&!w&&(f.include(da),f.uniforms.add(new we("depthMap",n=>n.mainDepth),new q("occludedOpacity",n=>n.occludedFragmentOpacity?.value??1))),t&&f.uniforms.add(new we("texOcclusion",n=>n.hudOcclusion?.attachment)),p?f.main.add(`
...
samplePos += (vec2(1.0, -1.0) * texelSize) * scaleFactor;`),s?f.main.add(l`
      ...
      if (outlineSize > 0.25) {
        ...
        ${A(!w,l`fragColor = vec4(compositeColor, compositeAlpha);`)}
      } else {
        if (fillAlphaFactor < textureAlphaCutoff) {
          discard;
        }

        ${A(!w,l`fragColor = premultiplyAlpha(fillPixelColor);`)}
      }
      ...
      `):f.main.add(l`
        ...
        ${A(!w,l`fragColor = texColor * premultiplyAlpha(vcolor);`)}
      `),m&&!w&&f.main.add(l`
