import{LW as be,LS as we,Mr as De,B0 as f,B9 as w,L$ as Ve,Ko as W,B1 as r,dj as z,As as ee,LV as xe,B7 as E,ab as te,a8 as A,gy as F,Ms as Le,gZ as ie,A$ as ne,KJ as S,eA as m,a7 as v,Mt as se,Bb as ae,a9 as o,oF as re,gx as ye,ua as Ee,ac as Se,ao as le,fv as oe,gv as Ce,LT as Me,AG as Ae,KH as $e,Li as Re,Ba as H,bC as Te,t8 as ce,ta as he,_ as de,eC as Oe,bt as G,sK as q,e as c,g as j,ky as pe,eD as ue,a5 as Ie,aa as I,nN as Ue,KU as qe,nP as ze,Mu as je,Bi as V,qq as Ne,qr as K,Mv as Be,pp as We,Mw as $,Mx as Fe,zF as k,u6 as He,xB as Ge,u7 as Ke,u8 as ke,u9 as Xe,ub as Ze,f as C,My as Je,bv as X}from"./index-B5CEZo53.js";import{t as Qe}from"./VisualElement-DLbhU3vJ.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
